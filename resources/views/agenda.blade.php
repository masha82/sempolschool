                            ...
                            <div class="grid-inner row g-0">
                                <div class="col-md-4">
                                    <a class="entry-image" href="#" data-lightbox="image"><img
                                            src="{{ asset('gambar_agenda/' . $item->foto) }}"
                                            alt="Standard Post with Image"></a>
                                </div>
                                <div class="col-md-8 ps-md-4">
                                    <div class="entry-title title-sm">
                                        <h2><a href="{{route('agendasekolah.show',$item->id)}}">{{ $item->nama }}</a></h2>
                                    </div>
                                    ...
                                    <div class="entry-content">
                                        <a href="{{route('agendasekolah.show',$item->id)}}" class="button button-border button-rounded">Baca
                                            selengkapnya</a>
                                    </div>
                                </div>
                            </div>
